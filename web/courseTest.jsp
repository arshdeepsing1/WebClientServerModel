    ...
    <head>
        ...
        <script>
            ...
            function showquestions(cid)
            {
                ...
                xml.open("GET", "./fetchrandomQuesCourse?cid=" + cid, false);
                xml.send();
            }
            ////////////////////////////////////////////////////////////////////
...
//                        }, 1000);
            ...
            function saveresultDB() {
                ...
                xmlhttp1.open("GET", "./thecoursetest", true);
                xmlhttp1.send();
            ...
            function go4(ind) {
                if (ind == 0) {
                    ...
                    xmlhttp.open("get", "./generatequestionCourse?ind=" + ind, true);
                    xmlhttp.send();
                } else {
                    var i2 = ind - 1;
                    xmlhttp.onreadystatechange = go1;
                    xmlhttp.open("get", "./generatequestionCourse?ind=" + i2, true);
                    xmlhttp.send();
                }
            }
            function go5(ind1) {
                var i1 = ind1 + 1;
                xmlhttp.onreadystatechange = go1;
                xmlhttp.open("get", "./generatequestionCourse?ind=" + i1, true);
                xmlhttp.send();
            }
            ////////////////////////////////////////////////////////////////////
            function go1()
            ...
            function unselect(ind) {
                ...
                xmlhttp.open("get", "./unselectservletCourse?newindex=" + newindex, true);
                xmlhttp.send();
            }
            function go6(userans, ind) {
                ...
                xmlhttp.open("get", "./resultservletCourse?newindex=" + newindex + "&useranswer=" + userans, true);
                xmlhttp.send();
            }
            function hideddd()
            {
...
//                document.getElementById("teststart").style.visibility = 'visible';
            ...
            function playresult() {
                window.location.href = "testResult2.jsp";
            }
                ...
                <div class="col-sm-12">
                    ...
                    <div id="q">
                        ...
                        <div  class="form-group">
                            <label>Select Course</label><select class="form-control" id="cat" name="cat">
                        ...
                        <br>
                        <button type="button" class="main-button btn-lg" onclick="setselectedcourse(cat.value)"> START TEST </button>
                    </div>
                </div>
            </div>
            <% ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////%>
